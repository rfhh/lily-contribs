#ifndef lint
static char rcsid[] = "$Header: /usr/local/cvsroot/niffio/src/lib/niffio/storenif.c,v 1.1 1996/06/06 04:57:44 tim Exp $";
#endif
/***************************************************************************/
/*
 * NAME
...
NIFFIOStartNiff(void)
{
        ...
        chunkForm.fccType = niffformNiff;
...
NIFFIOStartDataSection(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistDataSection;
...
NIFFIOStartPage(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistPage;
...
NIFFIOStartParts(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistParts;
...
NIFFIOStartSetupSection(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistSetupSection;
...
NIFFIOStartStaff(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistStaff;
...
NIFFIOStartSystem(void)
{
        ...
        chunkList.fccId = RIFFIO_FOURCC_LIST;
        chunkList.fccType = nifflistSystem;
...
NIFFIOchunkChnkLenTable(void)
{
        ...
        chunk.fccId = niffckidChnkLenTable;
...
NIFFIOchunkPageHeader(void)
{
        ...
        chunk.fccId = niffckidPageHeader;
...
NIFFIOchunkStaffHeader(void)
{
        ...
        chunk.fccId = niffckidStaffHeader;
...
NIFFIOchunkStringTable(void)
{
        ...
        chunk.fccId = niffckidStringTable;
...
NIFFIOchunkSystemHeader(void)
{
        ...
        chunk.fccId = niffckidSystemHeader;
    ...
    SHORT numberOfStaves)
{
    ...
    Barline.numberOfStaves = numberOfStaves;

    /* Write the chunk header */
    chunk.fccId = niffckidBarline;
    ...
    BYTE octaveNumber)
{
    ...
    /* Initialize the chunk's structure */
    Clef.shape = shape;
    Clef.staffStep = staffStep;
    Clef.octaveNumber = octaveNumber;

    /* Write the chunk header */
    chunk.fccId = niffckidClef;
    ...
    RATIONAL duration)
{
    ...
    RIFFIOChunk chunk;
    niffNotehead Notehead;

    /* Initialize the chunk's structure */
    Notehead.shape = shape;
    Notehead.staffStep = staffStep;
    Notehead.duration = duration;

    /* Write the chunk header */
    chunk.fccId = niffckidNotehead;
    ...
    RATIONAL duration)
{
    ...
    /* Initialize the chunk's structure */
    Rest.shape = shape;
    Rest.staffStep = staffStep;
    Rest.duration = duration;

    /* Write the chunk header */
    chunk.fccId = niffckidRest;
    ...
    BYTE bottomNumber)
{
    ...
    RIFFIOChunk chunk;
    niffTimeSignature TimeSignature;

    /* Initialize the chunk's structure */
    TimeSignature.topNumber = topNumber;
    TimeSignature.bottomNumber = bottomNumber;

    /* Write the chunk header */
    chunk.fccId = niffckidTimeSignature;
