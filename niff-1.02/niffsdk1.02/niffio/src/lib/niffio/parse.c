#ifndef lint
static char rcsid[] = 
"$Header: /usr/local/cvsroot/niffio/src/lib/niffio/parse.c,v 1.2 1996/06/12 07:00:15 tim Exp $";
#endif
/*
                       ...
                       NIFFIOChunkContext *pctxChunk)
{
    ...
    if (isRegistered)
    {
        pTaggedChunkEntry = entry.value.pv;
                       ...
                       NIFFIOChunkContext *pctxChunk)
{
    ...
    if (isRegistered)
    {
        pAtomicChunkEntry = entry.value.pv;
