...
=head2 Who do I complain to?

Tim Butler (tim@netbox.com)

=head2 What is in the NIFF SDK?
...
=head2 What platforms does the NIFF SDK support?
...
=head2 Where can I get the NIFF SDK?
...
=head2 What is the latest version of the NIFF SDK?
...
=head2 What features are provided by NIFFSDK?
...
=head2 How do I find my way around the NIFF SDK?
...
=head1 How do I install the NIFF SDK?
...
=head2 What are those extraneous T's at the beginning of some sentences?

I used a single (silent) T to start some sentences that don't begin with a
capital letter. It's a kludge.

=head1 USING THE NIFFSDK

=head2 How can I learn about the NIFF SDK?
...
=head2 How do I write a NIFF file?
...
=head2 Is there an easy way to write the Chunk Length Table?
...
=head1 Is there an easy way to write the String Table?
...
=head2 How do I read a NIFF file?
...
=head2 How do I parse a NIFF file?
...
=head2 What information does the parser provide to the user callback functions?
...
=head2 What is the difference between a Raw and Cooked Chunk?
...
=head2 What are the coding conventions?
...
=head2 Why are there so many types of registration routines and callback functions?
